...
const Checkout = (props) => {
    ...
    return (
        <div className="w-full min-h-screen">
            ...
            <div className="flex flex-col gap-y-12 xl:flex-row xl:gap-x-8 items-center xl:items-start w-full max-w-[1024px] mx-auto pt-16 pb-20 px-6 lg:px-10 xl:px-12">
                <div className="flex flex-col gap-y-7 w-full xl:w-[60%]">
                ...
                <div className="w-full max-w-[400px] bg-[#081a36] p-5 rounded-md xl:mt-4">
                    ...
                    <button
                        className="bg-white py-2 text-[#081a36] mt-6 rounded-sm w-full flex items-center justify-center"
